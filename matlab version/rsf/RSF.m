...
try
    switch lower(method)
        ...
        case 'all'
            ...
            d1 = distance(W_1'*covm1*W_1, W_1'*covm2*W_1, metric);
            d2 = distance(W_2'*covm1*W_2, W_2'*covm2*W_2, metric);
            d3 = distance(W_3'*covm1*W_3, W_3'*covm2*W_3, metric);
            d4 = distance(W_4'*covm1*W_4, W_4'*covm2*W_4, metric);
            [~,ind] = max([d1,d2,d3,d4]);
...
dd=distance(W'*covm1*W, W'*covm2*W, metric);
